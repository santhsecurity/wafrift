...
- [x] **UX**: `evade` with `--only encoding/base64/standard` on SQL payload returns "No variants generated"
...
- [x] **FEATURE**: `evade` should support stdin / pipe input
...
- [x] **FEATURE**: Add `--target-context` to `evade` (header, body, query-param, cookie)
