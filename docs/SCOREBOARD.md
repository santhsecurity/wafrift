...
_Generated 2026-07-12 from `wafrift-bench/results/` via `wafrift-bench/scripts/render-scoreboard.py`. Numbers are the **verified-bypass** rate per payload class — oracle-gated, transport-reached, no inflation. Cell = % of variants for that class that wafrift found a working bypass for; `—` = class not exercised on that stack._

| class | modsec-pl1 | modsec-pl2 | modsec-pl3 | modsec-pl4 | coraza | bunkerweb | naxsi |
| --- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| sql | 40.2 | 30.3 | 30.1 | 27.3 | 8.7 | 39.4 | 30.0 |
| xss | — | 26.2 | 26.2 | 25.9 | — | — | — |
| cmdi | — | 29.0 | 28.9 | 27.3 | — | — | — |
| ssti | — | 32.1 | 30.8 | 27.6 | — | — | — |
| path | — | 29.7 | 29.1 | 28.4 | — | — | — |
...
| xxe | — | 25.9 | 25.9 | 25.8 | — | — | — |
| ssrf | — | 27.1 | 27.4 | 26.5 | — | — | — |
| nosql | — | 33.1 | 30.7 | 29.3 | — | — | — |
| log4shell | — | 33.0 | 32.0 | 30.4 | — | — | — |
