 ...
 * calls shadowd_handle() which exits with a 403 before we get here.
 *
...
use Shadowd\Connector\Connector;

// The connector reads config from the path set in SHADOWD_CONFIG env var,
// which we point at /etc/shadowd/shadowd.ini via Docker environment.
$connector = new Connector();
$status = $connector->start();
