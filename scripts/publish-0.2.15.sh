#!/usr/bin/env bash
# Publish wafrift v0.2.15 to crates.io.
#
...
#
# Usage:
#     scripts/publish-0.2.15.sh                 # publish for real
#     WAIT_BETWEEN_PUBLISH=60 scripts/publish-0.2.15.sh   # slower
...
echo
echo "==> All v0.2.15 crates published."
echo "==> Next: git tag v0.2.15 && git push origin v0.2.15 (triggers prebuilt-binary release workflow)."
